...
-- 创建系统账号
INSERT INTO `user` (uid, name, short_no, phone, zone, search_by_phone, search_by_short, new_msg_notice, voice_on,
                    shock_on, msg_show_detail, status, is_upload_avatar, category, robot)
VALUES ('u_10000', '系统账号', 10000, '13000000000', '0086', 0, 0, 0, 0, 0, 0, 1, 1, 'system', 1);
INSERT INTO `user` (uid, name, short_no, phone, zone, search_by_phone, search_by_short, new_msg_notice, voice_on,
                    shock_on, msg_show_detail, status, is_upload_avatar, category)
VALUES ('fileHelper', '文件传输助手', 20000, '13000000001', '0086', 0, 0, 0, 0, 0, 0, 1, 1, 'system');
...
(
    40
) DEFAULT '' NOT NULL COMMENT '用户OpenId',
    login_ip VARCHAR
(
    40
) DEFAULT '' NOT NULL COMMENT '最后一次登录ip',
    created_at timeStamp not null DEFAULT CURRENT_TIMESTAMP comment '创建时间',
    updated_at timeStamp not null DEFAULT CURRENT_TIMESTAMP comment '更新时间'
